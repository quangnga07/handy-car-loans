	...
	<tr>
		<td align="center" style="height: 200px;">
			<table width="700px">
				<tr>
					<td>
						<img src="<?php echo base_url() ?>assets/img/header-email.png" width="700" height="190" />
					</td>
				</tr>
			</table>
		</td>
		...
		<td align="center">
			<table width="700px">
				<tr>
					...
					<td align="center">
						<img src="<?php echo base_url() ?>assets/img/customer-support-small.png" />
					</td>
				</tr>
				<tr>
					<td width="75%" style="vertical-align: top;">
						<div style="padding: 35px; background-color: #eaebeb; color: #616060; font-size: 14px;">
							...
							<div style="margin-top: 35px;">
								<a href="{url}">
									<img alt="Complete Application" src="<?php echo base_url() ?>assets/img/complete_application_submit.png" style="margin: 0 auto; display: block; width: 211px; height: 46px;" />
								</a>
							</div>
						</div>
					</td>
