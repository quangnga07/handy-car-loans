<div id="content">
	...
	<div id="breadcrumb">
		...
		<a href="<?php echo site_url('admin/supervisor_approval');?>" class="current">Supervisor Approval</a>
	</div>
			...
			<div class="span12">
				<div class="widget-box incomplete-box">
					...
					<div class="widget-content incomplete-content nopadding">
						<table class="table incomplete-table table-bordered table-striped data-4-table">
							<thead>
								<tr>
							...
							<tbody id="result">
								<?php
								foreach( $supervisor_approval as $applicant ) :
									$row  = $applicant;
									$id   = 'HCL'.$row->id;
...
function submit_search(){
	...
	$.ajax({
		url: '<?php echo site_url('admin/search/search_tank_4'); ?>',
		type: 'post',
		dataType: 'json',
		data:{
			searchTank_4:'yes',
