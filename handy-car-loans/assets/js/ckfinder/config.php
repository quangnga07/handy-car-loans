...
$basepart = explode('assets/js/ckfinder/',$_SERVER['SCRIPT_FILENAME']);
$basepart = explode($_SERVER['DOCUMENT_ROOT'],$basepart[0]);
//print_r('http://'.$_SERVER['SERVER_NAME'].$basepart[1].'/uploads/files/full/');exit;

$baseUrl = 'http://'.$_SERVER['SERVER_NAME'].$basepart[1].'/uploads/files/full/';
